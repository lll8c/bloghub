...
func (m *MockArticleAuthorRepository) FindById(ctx context.Context, id int64) (domain.Article, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleAuthorRepositoryMockRecorder) FindById(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindById", reflect.TypeOf((*MockArticleAuthorRepository)(nil).FindById), ctx, id)
}
